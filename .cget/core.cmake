...
macro(CGET_NUGET_BUILD name version)    
    ...
    CGET_EXECUTE_PROCESS(COMMAND ${CGET_NUGET} install ${name}${searchsuffix}  -version ${version} -outputdirectory "${OUTPUTDIR}")
...
macro(CGET_PARSE_OPTIONS name)
  ...
  set(oneValueArgs NUGET_PACKAGE GITHUB GIT HG SVN URL VERSION FINDNAME COMMIT_ID REGISTRY_VERSION OPTIONS_FILE)
...
function(CGET_DIRECT_GET_PACKAGE name)
  ...
  if (NOT EXISTS ${STAGING_DIR})
    if (MSVC AND NUGET_PACKAGE)
        CGET_NUGET_BUILD(${NUGET_PACKAGE})
    elseif (ARGS_GIT)
